...
#'   legend("topright", inset = c(-.5, 0), c("homerange", "camera trap"), cex = .8, col = c("black", "red"), pch = c(1, 15))
#' }
calc_detection <- function(n, ntraps, homeranges, traps, tau) {
...
generate_capture_hist <- function(n, ntraps, nsample_cap, tau, homeranges) {
...
#'
#' @examples
generate_presence_absence <- function(nsites, nsample_pa, homeranges, tau) {
...
capture_hist <- generate_capture_hist(n, ntraps, nsample_cap, tau, homeranges)
capture_hist

presence_absence <- generate_presence_absence(nsites, nsample_pa, homeranges, tau)
presence_absence
```
