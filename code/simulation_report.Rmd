...
```{r fig.height = 10, fig.width = 20, results='hide', message=FALSE, warning=FALSE, echo=FALSE}
...
ggplot(data = SimStudy8, mapping = aes(x = tau, y = credible_proportion)) +
  ...
  geom_hline(yintercept = 0.95, lty = 2) +
  ggtitle("Credible Proportion vs Tau - Fourth Simulation")
