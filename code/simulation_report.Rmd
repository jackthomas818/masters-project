...
SimStudy8 <- subset(summary_stats_SimStudy8, (N_actual >= 75 & N_actual <= 200) & nsites == 100 & ntraps == 6)
...
ggplot(data = SimStudy8, mapping = aes(x = tau, y = credible_width)) +
  geom_point() +
  facet_wrap(vars(N_actual), scales = "free", labeller = as_labeller(pop_labeller)) +
  ggtitle("Credible Interval Width vs. Tau") +
  theme(plot.margin = margin(10, 10, 10, 10)) +
  xlab("Tau") +
...
ggplot(data = SimStudy8, mapping = aes(x = n_captured, y = N_mean)) +
  ...
  facet_wrap(vars(N_actual), scales = "free", labeller = as_labeller(pop_labeller)) +
  geom_abline(slope = 1) +
  ggtitle("Population Estimate vs. Number Captured") +
  theme(plot.margin = margin(10, 10, 10, 10)) +
...
ggplot(data = SimStudy8, mapping = aes(x = tau, y = N_mean)) +
  ...
  ggtitle("Population Estimate vs. Tau") +
  theme(plot.margin = margin(10, 10, 10, 10)) +
  xlab("Tau") +
  ylab("Population Estimate")
...
SimStudy8_pa <- subset(summary_stats_SimStudy8, (N_actual >= 75 & N_actual <= 200) & (nsites == 100) & ntraps == 6)
ggplot(data = SimStudy8_pa, mapping = aes(x = pa_detects, y = N_mean)) +
  geom_point() +
  facet_wrap(vars(N_actual), scales = "free", labeller = as_labeller(pop_labeller)) +
  ggtitle("Population Estimate vs. Presence-Absence Detections") +
  xlab("Total Presence-Absence Detections") +
  ylab("Population Estimate") +
  theme(plot.margin = margin(10, 20, 10, 10))
ggsave("SimStudy8_N_mean_vs_pa_detects.png", device = "png", dpi = 300)

ggplot(data = SimStudy8_pa, mapping = aes(x = n_captured, y = pa_detects)) +
  geom_point() +
  facet_wrap(vars(N_actual), scales = "free", labeller = as_labeller(pop_labeller)) +
  ggtitle("Presence-Absence Detections vs. Number Captured") +
  theme(plot.margin = margin(10, 10, 10, 10)) +
  xlab("Number Captured") +
...
ggplot(data = SimStudy8, mapping = aes(x = n_captured / N_actual, y = sd_bias)) +
  geom_point() +
  facet_wrap(vars(N_actual), scales = "free", labeller = as_labeller(pop_labeller)) +
  ggtitle("Standard Deviation Bias vs. Population Proportion Captured") +
  theme(plot.margin = margin(10, 10, 10, 10)) +
  xlab("Population Proportion Captured") +
  ylab("Standard Deviation Bias")
...
ggplot(data = SimStudy8_N_actual, mapping = aes(x = N_actual, y = N_mean, color = get(var_color))) +
  geom_point() +
  ggtitle("Population Estimate vs. Actual Population") +
...
ggplot(data = SimStudy12, mapping = aes(x = tau, y = credible_proportion)) +
  geom_point() +
...
ggplot(data = SimStudy12, mapping = aes(x = n_captured, y = N_mean)) +
  geom_point() +
  facet_wrap(vars(p), scales = "free", labeller = as_labeller(p_labeller)) +
  geom_abline(slope = 1) +
  ggtitle("Population Estimate vs. Number Captured") +
...
ggplot(data = SimStudy12, mapping = aes(x = tau, y = sd_bias)) +
  geom_point() +
  facet_wrap(vars(p), scales = "free", labeller = as_labeller(p_labeller)) +
  ggtitle("Standard Deviation Bias vs. Tau") +
  theme(plot.margin = margin(10, 10, 10, 10)) +
...
ggplot(data = SimStudy12, mapping = aes(x = n_captured / N_actual, y = sd_bias)) +
  geom_point() +
  facet_wrap(vars(p), scales = "free", labeller = as_labeller(p_labeller)) +
  ggtitle("Standard Deviation Bias vs. Population Proportion Captured") +
  theme(plot.margin = margin(10, 10, 10, 10)) +
...
SimStudy12_delta <- subset(summary_stats_SimStudy12, N_actual == 500 & nsites == 64 & ntraps == 5 & sigma == 1 & p == 0.75)

ggplot(data = SimStudy12_delta, mapping = aes(x = n_captured, y = N_mean)) +
  geom_point() +
  facet_wrap(vars(delta), scales = "free", labeller = label_both) +
  ggtitle("Population Estimate vs. Number Captured") +
  geom_abline(slope = 1) +
  theme(plot.margin = margin(10, 10, 10, 10)) +
  xlab("Number Captured") +
  ylab("Population Estimate")
ggsave("SimStudy12_N_mean_vs_n_captured_delta.png", device = "png", dpi = 300)

SimStudy12_sigma <- subset(summary_stats_SimStudy12, N_actual == 500 & nsites == 64 & ntraps == 5 & delta == 1 & p == 0.75)

ggplot(data = SimStudy12_sigma, mapping = aes(x = n_captured, y = N_mean)) +
  geom_point() +
  facet_wrap(vars(sigma), scales = "free", labeller = label_both) +
  ggtitle("Population Estimate vs. Number Captured") +
  geom_abline(slope = 1) +
  theme(plot.margin = margin(10, 10, 10, 10)) +
  xlab("Number Captured") +
  ylab("Population Estimate")
ggsave("SimStudy12_N_mean_vs_n_captured_sigma.png", device = "png", dpi = 300)
```
